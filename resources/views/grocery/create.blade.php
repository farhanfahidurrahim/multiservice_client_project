...
<h3>Create New Grocery</h3>
@endsection
@section('breadcrumb-items')
<a href="{{ route('grocery.index') }}" class="btn btn-danger">All List</a>
@endsection
@section('content')
        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-header">
                    <h5>Enter Gorcery Info</h5>
                </div>
                <form class="form theme-form" method="POST" action="{{ route('grocery.store') }}" enctype="multipart/form-data">
                	@csrf
                    <div class="card-body">
                        <div class="row">
                            <div class="col">
