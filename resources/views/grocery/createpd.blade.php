...
<a href="{{ route('grocery.productdetails.index') }}" class="btn btn-primary">All Product Details</a>
@endsection
@section('content')
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="card">
                ...
                <form class="form theme-form" method="POST" action="{{ route('grocery.productdetails.store') }}" enctype="multipart/form-data">
                    @csrf
                    <div class="card-body">
                        <div class="row">
                            <div class="col">
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-9">
                                        <select class="custom-select form-select" id="division" name="grocery_id" required>
