...
<h3>Create New Info Retailer</h3>
@endsection
@section('breadcrumb-items')
<a href="{{ route('retailer.index') }}" class="btn btn-danger">All List</a>
@endsection
@section('content')
        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-header">
                    <h5>Enter Retailer Info</h5>
                </div>
                <form class="form theme-form" method="POST" action="{{ route('retailer.store') }}" enctype="multipart/form-data">
                	@csrf
                    <div class="card-body">
                        <div class="row">
                            <div class="col">
