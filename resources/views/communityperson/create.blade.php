...
<h3>Create Community Person</h3>
@endsection
@section('breadcrumb-items')
<a href="{{ route('communityperson.index') }}" class="btn btn-danger">All List</a>
@endsection
@section('content')
        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-header">
                    <h5>Enter Community Person Info</h5>
                </div>
                <form class="form theme-form" method="POST" action="{{ route('communityperson.store') }}" enctype="multipart/form-data">
                	@csrf
                    <div class="card-body">
                        <div class="row">
                            <div class="col">
